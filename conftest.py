...
collect_ignore = [
    ...
    'src/setuptools/tests/mod_with_constant.py',
    'src/setuptools/_distutils',
    'src/_distutils_hack',
    'src/setuptools/extern',
    'src/pkg_resources/extern',
    'src/pkg_resources/tests/data',
    'src/setuptools/_vendor',
    'src/pkg_resources/_vendor',
]
